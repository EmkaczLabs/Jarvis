...
class SpeechPlayer:
    ...
    This class is designed to run in a separate thread, continuously checking for audio messages to process
    until a shutdown event is set. It plays audio messages, handles end-of-stream tokens, and manages the conversation history.
    """
